...
// Reset the score and the player and computer choice
function resetAll() {
  playerScoreNumber = 0;
...
function updateScore(playerChoice) {
  if (playerChoice === computerChoice) {
    ...
    if (choice.defeats.indexOf(computerChoice) > -1) {
      startConfetti();
      resultText.textContent = "Victory is Yours!!";
      playerScoreNumber++;
      playerScoreEl.textContent = playerScoreNumber;
    } else {
...
// Call the functions to process turn
...
// Startup, set the initial values
resetAll();
